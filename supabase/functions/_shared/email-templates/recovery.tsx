            ...
            <table role="presentation" style={{ width: '100%', maxWidth: '600px', borderCollapse: 'collapse', backgroundColor: '#ffffff', borderRadius: '16px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
              ...
              <tr>
                <td style={{ padding: '40px 30px' }}>
                  <h2 style={{ color: '#18181b', fontSize: '24px', fontWeight: 600, margin: '0 0 16px 0' }}>Recuperar Contraseña</h2>
                  <p style={{ color: '#52525b', fontSize: '16px', lineHeight: 1.6, margin: '0 0 24px 0' }}>
                    Recibimos una solicitud para restablecer la contraseña de tu cuenta en Trado. Haz clic en el botón de abajo para crear una nueva contraseña:
                  </p>
                  ...
                  <p style={{ color: '#71717a', fontSize: '14px', margin: '16px 0 0 0' }}>
