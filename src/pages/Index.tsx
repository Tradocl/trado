...
const FAQ_ITEMS = [
  ...
  { q: "¿Cuánto cobra Trado por cada transacción?", a: "Depende de cómo se pague. Con tarjeta es un 5% del monto. Con transferencia bancaria cobramos bastante menos y además baja mientras más grande sea la operación: parte en 3,5% y llega a 2,5%. El mínimo es $1.000 por operación. La comisión la asume quien crea la sala, y no hay costos ocultos ni suscripciones." },
  { q: "¿Por qué la transferencia sale más barata que la tarjeta?", a: "Porque al pagar con tarjeta el procesador de pagos se lleva una parte, y esa la asumimos nosotros. Cuando pagas por transferencia ese costo no existe y te lo traspasamos completo. En una operación de $2.000.000, por ejemplo, la diferencia son más de $40.000 a tu favor." },
