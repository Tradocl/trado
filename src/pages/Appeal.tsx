                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-green-700 dark:text-green-300 mb-3">
                            {appeal.status === "resuelta_a_favor_comprador" && "Decisión a favor del comprador"}
                            {appeal.status === "resuelta_a_favor_vendedor" && "Decisión a favor del vendedor"}
                            {appeal.status === "resuelta_parcial" && "Resolución parcial acordada"}
                            {appeal.status === "cerrada" && "Caso cerrado"}
                          </p>
