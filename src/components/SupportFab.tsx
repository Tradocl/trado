...
export const SupportFab = () => {
  ...
  return (
    // Antes abría un mailto:, que en un equipo sin cliente de correo configurado
    // no hace absolutamente nada. Mientras tanto /support —el Centro de Ayuda
    // con las preguntas frecuentes y el formulario que abre ticket— quedaba sin
    // ningún enlace desde la app, o sea inalcanzable para el usuario.
    <button
      type="button"
